...
#                script (type 'flashattn_bd.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/cfk30/OneDrive/Documents/ECE4910/thesis/flash_attn_vivado/flash_attn_vivado.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
