...
#
# Script generated by Vivado on Fri Apr 11 18:30:11 -0400 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : flashattn_bd.sh
...
#
# Usage        : flashattn_bd.sh
#                flashattn_bd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                flashattn_bd.sh [-reset_run]
#                flashattn_bd.sh [-reset_log]
#                flashattn_bd.sh [-help]
#
...
# script info
echo -e "flashattn_bd.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./flashattn_bd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib lib_pkg_v1_0_4 fifo_generator_v13_2_11 lib_fifo_v1_0_20 lib_srl_fifo_v1_0_4 lib_cdc_v1_0_3 axi_datamover_v5_1_35 axi_sg_v4_1_19 axi_dma_v7_1_34 proc_sys_reset_v5_0_16)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb flashattn_bd.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./flashattn_bd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: flashattn_bd.sh [-help]\n\
Usage: flashattn_bd.sh [-step]\n\
Usage: flashattn_bd.sh [-lib_map_path]\n\
Usage: flashattn_bd.sh [-reset_run]\n\
Usage: flashattn_bd.sh [-reset_log]\n\
Usage: flashattn_bd.sh [-keep_index]\n\
Usage: flashattn_bd.sh [-noclean_files]\n\n\
