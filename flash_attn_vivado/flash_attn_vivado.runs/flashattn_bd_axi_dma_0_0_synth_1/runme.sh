...
HD_PWD='C:/Users/cfk30/OneDrive/Documents/ECE4910/thesis/flash_attn_vivado/flash_attn_vivado.runs/flashattn_bd_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flashattn_bd_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flashattn_bd_axi_dma_0_0.tcl
