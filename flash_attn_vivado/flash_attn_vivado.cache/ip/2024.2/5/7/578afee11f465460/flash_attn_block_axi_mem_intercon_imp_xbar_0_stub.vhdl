...
-- Date        : Thu Mar 20 23:00:06 2025
-- Host        : DESKTOP-I99LGQ1 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ flash_attn_block_axi_mem_intercon_imp_xbar_0_stub.vhdl
-- Design      : flash_attn_block_axi_mem_intercon_imp_xbar_0
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "flash_attn_block_axi_mem_intercon_imp_xbar_0,axi_crossbar_v2_1_34_axi_crossbar,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "flash_attn_block_axi_mem_intercon_imp_xbar_0,axi_crossbar_v2_1_34_axi_crossbar,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_crossbar,x_ipVersion=2.1,x_ipCoreRevision=34,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynq,C_NUM_SLAVE_SLOTS=6,C_NUM_MASTER_SLOTS=3,C_AXI_ID_WIDTH=3,C_AXI_ADDR_WIDTH=64,C_AXI_DATA_WIDTH=64,C_AXI_PROTOCOL=0,C_NUM_ADDR_RANGES=1,C_M_AXI_BASE_ADDR=0x000000001000000000000000080000000000000000000000,C_M_AXI_ADDR_WIDTH=0x0000001b0000001b0000001b,C_S_AXI_BASE_ID=0x000000050000000400000003000000020000000100000000,C_S_AXI_THREAD_ID_WIDTH=0x000000000000000000000000000000000000000000000000,C_AXI_SUPPORTS_USER_SIGNALS=0,C_AXI_AWUSER_WIDTH=1,C_AXI_ARUSER_WIDTH=1,C_AXI_WUSER_WIDTH=1,C_AXI_RUSER_WIDTH=1,C_AXI_BUSER_WIDTH=1,C_M_AXI_WRITE_CONNECTIVITY=0x000000380000003800000038,C_M_AXI_READ_CONNECTIVITY=0x000000070000000700000007,C_R_REGISTER=0,C_S_AXI_SINGLE_THREAD=0x000000000000000000000000000000000000000000000000,C_S_AXI_WRITE_ACCEPTANCE=0x000000100000001000000010000000020000000200000002,C_S_AXI_READ_ACCEPTANCE=0x000000020000000200000002000000100000001000000010,C_M_AXI_WRITE_ISSUING=0x000000080000000800000008,C_M_AXI_READ_ISSUING=0x000000080000000800000008,C_S_AXI_ARB_PRIORITY=0x000000000000000000000000000000000000000000000000,C_M_AXI_SECURE=0x000000000000000000000000,C_CONNECTIVITY_MODE=1}";
