...
//Command     : generate_target flash.bd
//Design      : flash
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "flash,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=flash,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=2,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=12,da_clkrst_cnt=3,da_ps7_cnt=2,synth_mode=None}" *) (* HW_HANDOFF = "flash.hwdef" *) 
module flash
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire axi_dma_0_M_AXI_MM2S_RDATA;
  wire axi_dma_0_M_AXI_MM2S_RLAST;
  wire axi_dma_0_M_AXI_MM2S_RREADY;
  wire axi_dma_0_M_AXI_MM2S_RRESP;
  ...
  flash_axi_dma_0_1 axi_dma_0
       (.axi_resetn(rst_ps7_0_100M_peripheral_aresetn),
        ...
        .m_axi_mm2s_rdata({axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA,axi_dma_0_M_AXI_MM2S_RDATA}),
        .m_axi_mm2s_rlast(axi_dma_0_M_AXI_MM2S_RLAST),
        .m_axi_mm2s_rready(axi_dma_0_M_AXI_MM2S_RREADY),
        .m_axi_mm2s_rresp({axi_dma_0_M_AXI_MM2S_RRESP,axi_dma_0_M_AXI_MM2S_RRESP}),
  ...
  flash_axi_mem_intercon_2 axi_mem_intercon
       (.ACLK(processing_system7_0_FCLK_CLK0),
        ...
        .S00_AXI_araddr(axi_dma_0_M_AXI_MM2S_ARADDR[0]),
        .S00_AXI_arburst(axi_dma_0_M_AXI_MM2S_ARBURST[0]),
        .S00_AXI_arcache(axi_dma_0_M_AXI_MM2S_ARCACHE[0]),
        .S00_AXI_arlen(axi_dma_0_M_AXI_MM2S_ARLEN[0]),
        .S00_AXI_arprot(axi_dma_0_M_AXI_MM2S_ARPROT[0]),
        .S00_AXI_arready(axi_dma_0_M_AXI_MM2S_ARREADY),
        .S00_AXI_arsize(axi_dma_0_M_AXI_MM2S_ARSIZE[0]),
  ...
  flash_axi_smc_3 axi_smc
       (.M00_AXI_araddr(axi_smc_M00_AXI_ARADDR),
        ...
        .aclk(processing_system7_0_FCLK_CLK0),
        .aresetn(rst_ps7_0_100M_peripheral_aresetn));
  flash_matrix_cyclic_block_0_1 matrix_cyclic_block_0
  ...
  flash_processing_system7_0_1 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  flash_rst_ps7_0_100M_2 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
...
module flash_axi_mem_intercon_2
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  s00_couplers_imp_21M3J2 s00_couplers
       (.M_ACLK(M00_ACLK),
...
module s00_couplers_imp_21M3J2
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arburst,
