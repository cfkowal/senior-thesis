...
module flashattn_hls_deadlock_idx0_monitor ( // for module flashattn_flashattn_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 flashattn_hls_deadlock_idx2_monitor flashattn_hls_deadlock_idx2_monitor_U (
    .clock(clock),
    .reset(reset),
