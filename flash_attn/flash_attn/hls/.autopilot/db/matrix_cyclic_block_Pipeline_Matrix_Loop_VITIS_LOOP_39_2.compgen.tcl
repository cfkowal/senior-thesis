...
set name matrix_cyclic_block_mul_32s_32s_32_2_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename B_1 \
    op interface \
    ports { B_1_address0 { O 2 vector } B_1_ce0 { O 1 bit } B_1_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename B_2 \
    op interface \
    ports { B_2_address0 { O 2 vector } B_2_ce0 { O 1 bit } B_2_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename B_3 \
    op interface \
    ports { B_3_address0 { O 2 vector } B_3_ce0 { O 1 bit } B_3_q0 { I 32 vector } } \
} "
} else {
...
set InstName matrix_cyclic_block_flow_control_loop_pipe_sequential_init_U
set CompName matrix_cyclic_block_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix matrix_cyclic_block_ \
}"
} else {
