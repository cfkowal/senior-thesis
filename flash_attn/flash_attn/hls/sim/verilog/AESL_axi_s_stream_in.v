...
`define TV_IN_stream_in_TDATA "../tv/cdatafile/c.matrix_cyclic_block.autotvin_stream_in_V_data_V.dat"
`define INGRESS_STATUS_stream_in_TDATA "../tv/stream_size/stream_ingress_status_stream_in_V_data_V.dat"
`define TV_IN_stream_in_TKEEP "../tv/cdatafile/c.matrix_cyclic_block.autotvin_stream_in_V_keep_V.dat"
`define INGRESS_STATUS_stream_in_TKEEP "../tv/stream_size/stream_ingress_status_stream_in_V_keep_V.dat"
`define TV_IN_stream_in_TSTRB "../tv/cdatafile/c.matrix_cyclic_block.autotvin_stream_in_V_strb_V.dat"
`define INGRESS_STATUS_stream_in_TSTRB "../tv/stream_size/stream_ingress_status_stream_in_V_strb_V.dat"
`define TV_IN_stream_in_TLAST "../tv/cdatafile/c.matrix_cyclic_block.autotvin_stream_in_V_last_V.dat"
...
module AESL_axi_s_stream_in (
    ...
    fifo #(16, 32) fifo_stream_in_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(16, 4) fifo_stream_in_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(16, 4) fifo_stream_in_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(16, 1) fifo_stream_in_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    assign TRAN_stream_in_TVALID_temp = ~(stream_in_TDATA_empty || stream_in_TKEEP_empty || stream_in_TSTRB_empty || stream_in_TLAST_empty);
