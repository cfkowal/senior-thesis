...
`define TV_OUT_stream_out_TDATA "../tv/rtldatafile/rtl.matrix_cyclic_block.autotvout_stream_out_V_data_V.dat"
`define EGRESS_STATUS_stream_out_TDATA "../tv/stream_size/stream_egress_status_stream_out_V_data_V.dat"
`define TV_OUT_stream_out_TKEEP "../tv/rtldatafile/rtl.matrix_cyclic_block.autotvout_stream_out_V_keep_V.dat"
`define EGRESS_STATUS_stream_out_TKEEP "../tv/stream_size/stream_egress_status_stream_out_V_keep_V.dat"
`define TV_OUT_stream_out_TSTRB "../tv/rtldatafile/rtl.matrix_cyclic_block.autotvout_stream_out_V_strb_V.dat"
`define EGRESS_STATUS_stream_out_TSTRB "../tv/stream_size/stream_egress_status_stream_out_V_strb_V.dat"
`define TV_OUT_stream_out_TLAST "../tv/rtldatafile/rtl.matrix_cyclic_block.autotvout_stream_out_V_last_V.dat"
...
module AESL_axi_s_stream_out (
    ...
    fifo #(16, 32) fifo_stream_out_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(16, 4) fifo_stream_out_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(16, 4) fifo_stream_out_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(16, 1) fifo_stream_out_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    assign TRAN_stream_out_TREADY = ~(stream_out_TDATA_full || stream_out_TKEEP_full || stream_out_TSTRB_full || stream_out_TLAST_full);
