...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matrix_cyclic_block.autotvin.dat"
	set constFileTvOut       "matrix_cyclic_block.autotvout.dat"
	set constFileHdlTvIn     "matrix_cyclic_block.autohdltvin.dat"
	set constFileHdlTvOut    "matrix_cyclic_block.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
