...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "flashattn.autotvin.dat"
	set constFileTvOut       "flashattn.autotvout.dat"
	set constFileHdlTvIn     "flashattn.autohdltvin.dat"
	set constFileHdlTvOut    "flashattn.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
